        ...
        <div className="row  min-vh-100 align-items-center">
          <div className="col-lg-7 col-xl-7 col-xxl-6">
            <div className="hb-text">
              <h1 data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">Bem vindo<br /> <b>A</b> <span><br />VERGZ</span></h1>
              <p className="lead" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400"><span>Tattoo studio</span> focado em<span> realismo</span></p>
              ...
              <div className="info-bar" data-aos="fade-up" data-aos-duration="800" data-aos-delay="600">
                <p><Icon icon="bi-phone" /><span>+55 12 98204-7622</span></p>
                <p><Icon icon="bi-instagram" /><span>vergz.tattoo</span></p>
              </div>
            </div>
          </div>
        </div>
